		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "title Hello World Git App Title",
									"targetURL": "#sapbtphelloworldgit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldgit-display": {
								"semanticObject": "sapbtphelloworldgit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldgit",
									"url": sap.ui.require.toUrl("sap/btp/helloworldgit")
								}
							}
						}
					}
